      ...
      <div className="container relative min-h-[620px] py-16">
        <div className="grid grid-cols-1 items-center gap-12 sm:grid-cols-2">
          ...
          <div className="order-2 space-y-6 sm:order-1 sm:pr-20">
            ...
            >
              <Link to="/booking" className="rounded-md bg-primary px-6 py-3 text-base font-medium text-black transition duration-500 hover:bg-primary/80">
                Reserve now
              </Link>
              <Link to="#cars" className="button-outline">
                Explore fleet
              </Link>
            </div>
